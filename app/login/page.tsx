                ...
                <Container maxWidth="lg">
                    <Card padding="lg" className="bg-white/80 backdrop-blur-xl border border-white/50 shadow-2xl shadow-indigo-100/50">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600 mt-1">Sign in to continue building</p>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                        ...
                        <form action={handleSubmit} className="space-y-4">
                            ...
                            <Button
                                type="submit"
                                className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 shadow-lg shadow-indigo-200/50 border-0"
                                isLoading={isLoading}
                            >
                                Sign in
                            </Button>
