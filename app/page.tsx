...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      {/* Header */}
      <header className="h-16 relative z-50 w-full sticky top-0 bg-white/80 backdrop-blur-md border-b border-gray-100/50">
            ...
            {user ? (
              <>
                ...
                <Link href="/profile" className="relative group">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-medium text-sm shadow-lg shadow-indigo-200/50 ring-2 ring-white/50 hover:ring-indigo-200 transition-all duration-300 hover:scale-105">
