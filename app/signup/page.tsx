            ...
            <header className="h-16 relative z-10">
                <Container className="h-full flex items-center">
                    <Link href="/" className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-xl bg-linear-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                            ideY
                        </span>
                    </Link>
                </Container>
                ...
                <Container maxWidth="lg">
                    <Card padding="lg" className="bg-white/80 backdrop-blur-xl border border-white/50 shadow-2xl shadow-indigo-100/50">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600 mt-1">Start turning ideas into execution</p>
                        </div>
